...
function startAnimation() {
    ...
    function updateTimer() {
        ...
        if (remainingTime <= 0) // Arrêt de l'animation 
...
function getIntervalForRythme(rythme) {
    ...
    else if (rythme === "2") return [
        3000,
        7000
    ]; // 3 secondes, 7 secondes
    else if (rythme === "3") return [
        4000,
        6000
    ]; // 4 secondes, 6 secondes
    else if (rythme === "4") return [
        6000,
        4000
    ]; // 6 secondes, 4 secondes
...
function handleBreathRatio() {
    ...
    if (rythme === "1") imgElt.classList.add("rythme55");
    else if (rythme === "2") imgElt.classList.add("rythme37");
    else if (rythme === "3") ;
    else if (rythme === "4") imgElt.classList.add("rythme64");
}
